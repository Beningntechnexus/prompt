  ...
  return (
    <div className="container mx-auto px-4 py-16">
      <div className="max-w-3xl mx-auto text-center">
        <h1 className="text-4xl md:text-5xl font-extrabold tracking-tighter">About BBprompts</h1>
      ...
      <div className="max-w-4xl mx-auto mt-12">
        <Card className="bg-card/50">
          ...
          <CardContent className="space-y-4 text-card-foreground/80">
            ...
            <p>
              BBprompts was born out of a passion for leveraging the full potential of AI. Our mission is to build a comprehensive and community-driven library of prompts for a wide array of AI models and use cases. We believe that by providing a centralized platform for prompt discovery and sharing, we can empower creators, developers, researchers, and hobbyists to achieve more with AI.
            </p>
            <p>
              Whether you're a seasoned prompt engineer or just starting your journey with AI, BBprompts is here to be your trusted resource. Join our growing community and help us build the ultimate prompt library.
            </p>
          </CardContent>
        </Card>
      </div>
